...
urlpatterns = [
    ...
    path('logistics/update-order-status/',
         UpdateOrderStatusView.as_view(), name='update-order-status'),
    path('logistics/export-orders/',
         ExportOrdersCSVView.as_view(), name='export-orders'),
