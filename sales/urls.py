...
urlpatterns = [
    ...
    path('inventory-date-product/', InventoryDateSnapshotView.as_view(),
    ...
    path('current-database/', CurrentDatabaseModeView.as_view(),
